			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Sitemap de locais - Bolos e Doces Doçuras da Mila</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML de sitemap - Bolos e Doces Doçuras da Mila</title>
					</xsl:otherwise>
				</xsl:choose>
					...
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>Arquivo KML</h1>
															...
															<p>
									Este arquivo KML é gerado pelo plugin <a href="https://s.rankmath.com/home" target="_blank">Rank Math</a>. Ele é usado para fornecer informações de localização para o Google.								</p>
							
							<p>
								Aprenda mais sobre <a href="https://developers.google.com/kml/documentation/" target="_blank">arquivos KML</a>.							</p>
					...
					<xsl:otherwise>
						...
						<div id="content">
							<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &gt; 0">
								...
								<p>
									Este arquivo XML de índice do sitemap contém <strong><xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap)"/></strong> sitemaps.								</p>
